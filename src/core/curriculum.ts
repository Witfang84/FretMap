...
export const CURRICULUM: Lesson[] = [
  ...
  },
  {
    id: '2.2',
    phase: 2,
    title: 'B String Notes',
    description: 'Learn the natural notes on the B2 string.',
    challengeType: 'name-the-fret',
    targetStrings: [2],
    xpReward: 30,
  ...
  },
  {
    ...
    description: 'Learn the natural notes on the A5 string.',
    challengeType: 'name-the-fret',
    targetStrings: [5],
    xpReward: 30,
  ...
  },
  {
    ...
    description: 'Learn the natural notes on the D4 string.',
    challengeType: 'name-the-fret',
    targetStrings: [4],
    xpReward: 30,
  ...
  },
  {
    ...
    description: 'Learn the natural notes on the G3 string.',
    challengeType: 'name-the-fret',
    targetStrings: [3],
    xpReward: 30,
